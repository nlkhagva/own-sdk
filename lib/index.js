...
let SaleorManager = /** @class */ (() => {
    class SaleorManager {
        constructor(config, apolloConfig) {
            ...
            this.config = Object.assign(Object.assign(Object.assign({}, config_1.defaultConfig), config), { loadOnStart: Object.assign(Object.assign({}, config_1.defaultConfig.loadOnStart), config === null || config === void 0 ? void 0 : config.loadOnStart) });
