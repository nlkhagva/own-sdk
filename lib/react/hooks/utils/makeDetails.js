...
function makeDetails(createDetails) {
    return (variables) => {
        ...
        const config = helpers_1.useSaleorConfig();
        ...
        function initDetails() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                yield details.current.init(Object.assign({ channel: config.channel }, variables));
        ...
        }, [JSON.stringify(Object.assign({ channel: config.channel }, variables))]);
        if (willMount.current) {
            initDetails();
