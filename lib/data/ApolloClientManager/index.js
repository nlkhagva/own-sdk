    ...
    constructor(client) {
        ...
        this.createPayment = ({ amount, checkoutId, gateway, billingAddress, token, returnUrl, }) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const variables = {
                    ...
                    paymentInput: {
                        ...
                        billingAddress: {
                            city: billingAddress.city,
                            companyName: billingAddress.companyName,
                            country: globalTypes_1.CountryCode[(_24 = billingAddress === null || billingAddress === void 0 ? void 0 : billingAddress.country) === null || _24 === void 0 ? void 0 : _24.code],
                            countryArea: billingAddress.countryArea,
                            firstName: billingAddress.firstName,
                            lastName: billingAddress.lastName,
                            phone: billingAddress.phone,
                ...
                if ((_25 = data === null || data === void 0 ? void 0 : data.checkoutPaymentCreate) === null || _25 === void 0 ? void 0 : _25.errors.length) {
                    return {
                        error: (_26 = data === null || data === void 0 ? void 0 : data.checkoutPaymentCreate) === null || _26 === void 0 ? void 0 : _26.errors,
                    };
                }
                if ((_27 = data === null || data === void 0 ? void 0 : data.checkoutPaymentCreate) === null || _27 === void 0 ? void 0 : _27.payment) {
                    return {
        ...
        this.completeCheckout = ({ checkoutId, paymentData, redirectUrl, storeSource, }) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if ((_28 = data === null || data === void 0 ? void 0 : data.checkoutComplete) === null || _28 === void 0 ? void 0 : _28.errors.length) {
                    return {
                        error: (_29 = data === null || data === void 0 ? void 0 : data.checkoutComplete) === null || _29 === void 0 ? void 0 : _29.errors,
                    };
                }
